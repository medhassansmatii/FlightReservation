...
<body class="form-v8">
	<div class="page-content">
		<div class="form-v8-content">
			<div class="form-left">
				<img src="https://www.interexchange.org/articles/au-pairing-abroad/traveling-during-your-au-pair-extension-year/" alt="form">
			</div>
			<div class="form-right">
				<div class="tab">
					...
					<div class="tab-inner">
					 ...
					 <div class="tab-inner">
                            <a class="tablinks" onclick="openCity(event, 'sign-up')"  href="/flightreservation/showReg">Sign Up</a>
                        </div>
				</div>
