...
.page-content {
	width: 100%;
	margin: 0 auto;
	background-image: -moz-linear-gradient(136deg, rgb(0, 158, 253) 0%,
		rgb(42, 245, 152) 100%);
	background-image: -webkit-linear-gradient(136deg, rgb(0, 158, 253) 0%,
		rgb(42, 245, 152) 100%);
	background-image: -ms-linear-gradient(136deg, rgb(0, 158, 253) 0%,
		rgb(42, 245, 152) 100%);
	display: flex;
	display: -webkit-flex;
...
<body class="form-v8">
	<div class="page-content">
		<div class="form-v8-content">
			<div class="form-left">
				<img
					src="https://www.interexchange.org/articles/au-pairing-abroad/traveling-during-your-au-pair-extension-year/"
					alt="form">
			</div>
			<div class="form-right">
				...
				<div class="tab">
					...
					<div class="tab-inner">
					<a class="tablinks" onclick="openCity(event, 'sign-up')"  href="/flightreservation/showLogin">Sign In</a>
						
					</div>
					 
				</div>
				<form class="form-detail" action="registerUser" method="post">
					<div class="tabcontent" id="sign-up">
						<div class="form-row">
							<label class="form-row-inner"> <input type="text"
								name="firstName" id="full_name" class="input-text" required>
								<span class="label">First Name</span> <span class="border"></span>
							</label>
						</div>
						<div class="form-row">
							<label class="form-row-inner"> <input type="text"
								name="lastName" id="full_name" class="input-text" required>
								<span class="label">Last Name</span> <span class="border"></span>
							</label>
						</div>
						<div class="form-row">
							<label class="form-row-inner"> <input type="text"
								name="email" id="full_name" class="input-text" required>
								<span class="label">Email</span> <span class="border"></span>
							</label>
						</div>
						...
						<div class="form-row">
							<label class="form-row-inner"> <input type="password"
								...
								<span class="label">Password</span> <span class="border"></span>
							</label>
						</div>
						<div class="form-row">
							<label class="form-row-inner"> <input type="text"
								name="confirmPassword" id="full_name" class="input-text" required>
								<span class="label">Confirm Password</span> <span class="border"></span>
							</label>
						</div>
